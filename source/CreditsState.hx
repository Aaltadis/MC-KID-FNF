...
class CreditsState extends MusicBeatState
{
	...
	private static var creditsStuff:Array<Dynamic> = [ //Name - Icon name - Description - Link - BG Color
		...
		[''],
		['VS MC KID'],
		['Aaltadis',		'aalta',	"Made video, code, sprites, chart (music) and difficulty",				'https://youtube.com/c/AaltadisTheBadDev',	0xFF2A89A3],
		['EdenReaper',		'edenmogus',	"Helped with English translate",				'https://gamejolt.com/c/@EdenReaper',	0xFF181A1B],
	];
